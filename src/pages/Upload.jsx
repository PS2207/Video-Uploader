...
import { Container, Paper, Typography, Box, TextField, InputAdornment,Button,FormControl, Select, InputLabel,MenuItem } from '@mui/material'
import { Title, Description,CloudUpload,Visibility,Publish} from '@mui/icons-material';
...
const Upload = () => {
  return (
    <Container maxWidth="md">
      <Paper
        elevation={6}
        sx={{ padding: 4, marginTop: 5, borderRadius: 3 }}
      >
          ...
          <TextField 
            ...
            <Box display="flex" alignContent={'center'} justifyContent={'space-between'}>
                ...
                <label htmlFor="video-upload">
                  <Button variant="contained" component="span" color="secondary" startIcon={<CloudUpload/>}>
                     Upload Video Here
                  </Button>
                </label>
            </Box>
